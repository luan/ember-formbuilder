...
require "ember-formbuilder/formbuilder/views/text_field"
require "ember-formbuilder/formbuilder/views/text_area"
require "ember-formbuilder/formbuilder/views/select"
